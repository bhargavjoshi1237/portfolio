...
<div className=" w-[100%] flex ">
      <div className="w-[85%]  flex ml-auto mr-auto items-center justify-center">
        <div className="  ml-auto mr-auto w-full items-center justify-center">
          ...
          <p className="fon text-4xl mb-4">Inspired by Epic Games</p>
          <p className="fon text-3xl mb-4">Inspired by Epic Games</p>
          <p className="fon text-2xl mb-4">Inspired by Epic Games</p>
          <p className="fon text-xl mb-4">Inspired by Epic Games</p>
          <p className="fon text-lg mb-4">Inspired by Epic Games</p>
          {/* <p className="fon text-md mb-4">Inspired by Epic Games</p> */}
          {/* <p className="fon text-sm mb-4">Inspired by Epic Games</p> */}
          {/* <p className="fon text-xs mb-4">Inspired by Epic Games</p> */}
