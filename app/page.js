...
>>>>>>> ccbbafc7dff7b730901354752bc92b9d33abfec4
 ...
 <svg  className="h-[30px]" xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 24 24">
  ...
  <div className="w-full  ml-auto mr-auto    md:w-[75%] h-[80%]    md:mt-0">
...
<div className="w-[100%]  border-b md:w-[60%] items-center justify-center ml-auto mr-auto border-r border-[#e7e7e715] -mt-5  h-[800px]  md:h-[400px]  flex ">
...
<br />
<a href="https://drive.google.com/drive/folders/1ec3Q2CBx6Vmi8p8tjTRYgbZY3tG-j6Cl?usp=drive_link" className=" absolute z-[9999]" target="_blank">
  <button
    className=" absolute z-[9999] mb-4 w-[180px] h-[40px] bg-[#1a1a1a] text-white rounded-md
    border border-[#e7e7e715] transition-all duration-200 hover:bg-[#2a2a2a]
    active:scale-95 focus:outline-none focus:ring-2 focus:ring-[#e7e7e71]"
  >
    Visit All Designs
